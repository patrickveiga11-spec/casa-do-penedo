...
export const translations = {
  pt: {
    ...
    checkOut: "Check-out",
    guests: "Hóspedes",
    guestsChildren: "Crianças (0–12)",
    guestsYouth: "Jovens (13–17)",
    guestsAdults: "Adultos (18+)",
    guestsAtLeastOne: "Indica pelo menos 1 hóspede",
    guestsTotal: "Total de hóspedes",
    ...
    installApp: {
      ...
      manualHint: "No Chrome deve aparecer o botão Instalar. Se não aparecer, toca em ⋮ → Instalar aplicação.",
      separateNote: "",
      install: "Instalar",
      dismiss: "Agora não",
      close: "Fechar",
    ...
    installGestaoApp: {
      ...
      description: "Toca em Instalar para adicionar a app de gestão (ícone preto).",
      iosHint: "No Safari nesta página: Partilhar → Adicionar ao Ecrã Principal.",
      androidIntro: "Se o botão Instalar não aparecer, apaga primeiro a app antiga de reservas e abre esta página no Chrome.",
      androidHint: "",
      manualHint: "No Chrome deve aparecer o botão Instalar, como na app de reservas.",
      standaloneHint: "",
      openChromeHint: "Estás dentro da app de reservas — por isso não há menu nem botão Instalar. Abre a gestão no Chrome.",
      openChrome: "Abrir no Chrome",
      separateNote: "",
      step1: "Apaga a app antiga de reservas (ícone branco/antigo), se ainda tiveres.",
      step2: "Abre esta página no Chrome (não pela app).",
      step3: "Quando aparecer, toca em Instalar.",
      install: "Instalar",
      dismiss: "Agora não",
      close: "Fechar",
  ...
  en: {
    ...
    checkOut: "Check-out",
    guests: "Guests",
    guestsChildren: "Children (0–12)",
    guestsYouth: "Youth (13–17)",
    guestsAdults: "Adults (18+)",
    guestsAtLeastOne: "Please enter at least 1 guest",
    ...
    installApp: {
      ...
      manualHint: "Chrome should show an Install button. If not, tap ⋮ → Install app.",
      separateNote: "",
      install: "Install",
      dismiss: "Not now",
      close: "Close",
    ...
    installGestaoApp: {
      ...
      description: "Tap Install to add the management app (black icon).",
      iosHint: "In Safari on this page: Share → Add to Home Screen.",
      androidIntro: "If Install does not appear, remove the old booking app first and open this page in Chrome.",
      androidHint: "",
      manualHint: "Chrome should show an Install button, like the booking app.",
      standaloneHint: "",
      openChromeHint: "You are inside the booking app — that is why there is no menu or Install button. Open management in Chrome.",
      openChrome: "Open in Chrome",
      separateNote: "",
      step1: "Remove the old booking app icon if you still have it.",
      step2: "Open this page in Chrome (not from the app).",
      step3: "When it appears, tap Install.",
      install: "Install",
      dismiss: "Not now",
      close: "Close",
  ...
  fr: {
    ...
    book: "Réserver",
    sections: {
      disponibilidades: "Disponibilités",
      reservar: "Réserver",
      tarifas: "Tarifs",
      info: "Info",
    },
    ...
    checkOut: "Départ",
    guests: "Voyageurs",
    guestsChildren: "Enfants (0–12)",
    guestsYouth: "Jeunes (13–17)",
    guestsAdults: "Adultes (18+)",
    guestsAtLeastOne: "Indiquez au moins 1 voyageur",
    guestsTotal: "Total de voyageurs",
    ...
    installApp: {
      ...
      manualHint: "Chrome devrait afficher le bouton Installer. Sinon, touchez ⋮ → Installer l'application.",
      separateNote: "",
      install: "Installer",
    ...
    installGestaoApp: {
      ...
      description: "Touchez Installer pour ajouter l'app de gestion (icône noire).",
      iosHint: "Dans Safari sur cette page : Partager → Sur l'écran d'accueil.",
      androidIntro: "Si Installer n'apparaît pas, supprimez d'abord l'ancienne app de réservation et ouvrez cette page dans Chrome.",
      androidHint: "",
      manualHint: "Chrome devrait afficher le bouton Installer, comme pour l'app de réservation.",
      standaloneHint: "",
      openChromeHint: "Vous êtes dans l'app de réservation — c'est pourquoi il n'y a ni menu ni bouton Installer. Ouvrez la gestion dans Chrome.",
      openChrome: "Ouvrir dans Chrome",
      separateNote: "",
      step1: "Supprimez l'ancienne app de réservation si elle existe encore.",
      step2: "Ouvrez cette page dans Chrome (pas depuis l'app).",
      step3: "Quand il apparaît, touchez Installer.",
      install: "Installer",
      dismiss: "Pas maintenant",
      close: "Fermer",
  ...
  es: {
    ...
    checkOut: "Salida",
    guests: "Huéspedes",
    guestsChildren: "Niños (0–12)",
    guestsYouth: "Jóvenes (13–17)",
    guestsAdults: "Adultos (18+)",
    guestsAtLeastOne: "Indica al menos 1 huésped",
    guestsTotal: "Total de huéspedes",
    ...
    installApp: {
      ...
      manualHint: "Chrome debería mostrar el botón Instalar. Si no, toca ⋮ → Instalar aplicación.",
      separateNote: "",
      install: "Instalar",
      dismiss: "Ahora no",
      close: "Cerrar",
    ...
    installGestaoApp: {
      ...
      description: "Toca Instalar para añadir la app de gestión (icono negro).",
      iosHint: "En Safari en esta página: Compartir → Añadir a pantalla de inicio.",
      androidIntro: "Si no aparece Instalar, borra primero la app antigua de reservas y abre esta página en Chrome.",
      androidHint: "",
      manualHint: "Chrome debería mostrar el botón Instalar, como en la app de reservas.",
      standaloneHint: "",
      openChromeHint: "Estás dentro de la app de reservas — por eso no hay menú ni botón Instalar. Abre la gestión en Chrome.",
      openChrome: "Abrir en Chrome",
      separateNote: "",
      step1: "Borra la app antigua de reservas si todavía la tienes.",
      step2: "Abre esta página en Chrome (no desde la app).",
      step3: "Cuando aparezca, toca Instalar.",
      install: "Instalar",
      dismiss: "Ahora no",
      close: "Cerrar",
