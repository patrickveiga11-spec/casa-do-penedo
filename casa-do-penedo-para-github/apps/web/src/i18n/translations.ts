...
export const translations = {
  pt: {
    ...
    installGestaoApp: {
      ...
      standaloneHint: "Estás dentro de uma app antiga. Fecha-a, abre no Safari o link da gestão e adiciona ao ecrã inicial para ficar com o ícone preto.",
  ...
  en: {
    ...
    installGestaoApp: {
      ...
      standaloneHint: "You are inside an old app. Close it, open the management link in Safari, then add it to the home screen for the black icon.",
  ...
  fr: {
    ...
    installGestaoApp: {
      ...
      standaloneHint: "Vous êtes dans une ancienne app. Fermez-la, ouvrez le lien de gestion dans Safari, puis ajoutez-la à l'écran d'accueil pour l'icône noire.",
  ...
  es: {
    ...
    installGestaoApp: {
      ...
      standaloneHint: "Estás dentro de una app antigua. Ciérrala, abre el enlace de gestión en Safari y añádela a la pantalla de inicio para el icono negro.",
