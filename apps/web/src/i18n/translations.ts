...
export const translations = {
  pt: {
    ...
    installGestaoApp: {
      ...
      description: "Adiciona a app de gestão ao ecrã inicial (ícone com fundo preto).",
      iosHint: "No Safari, nesta página /gestao: toca em Partilhar e depois em «Adicionar ao Ecrã Principal».",
      androidHint: "No Chrome: 1) apaga o ícone antigo da gestão se existir 2) abre este link no Chrome 3) toca ⋮ 4) «Instalar aplicação» ou «Adicionar à página inicial».",
      manualHint: "No menu do browser (⋮ ou Partilhar), nesta página /gestao, escolhe «Instalar app» ou «Adicionar ao ecrã inicial».",
      standaloneHint: "Estás dentro de uma app antiga. Fecha-a por completo, abre este link no Chrome e instala de novo (⋮ → Instalar aplicação).",
      separateNote: "Tem de ser a partir desta página de gestão. A app de reservas (fundo branco) é outra — instala-se na página pública.",
      install: "Instalar",
      dismiss: "Agora não",
    },
  },
  en: {
    ...
    installGestaoApp: {
      ...
      description: "Add the management app to your home screen (black-background icon).",
      iosHint: "In Safari, on this /gestao page: tap Share, then «Add to Home Screen».",
      androidHint: "In Chrome: 1) remove the old management icon if present 2) open this link in Chrome 3) tap ⋮ 4) «Install app» or «Add to Home screen».",
      manualHint: "In the browser menu (⋮ or Share), on this /gestao page, choose «Install app» or «Add to Home Screen».",
      standaloneHint: "You are inside an old app. Close it fully, open this link in Chrome, then install again (⋮ → Install app).",
      separateNote: "You must do this from the management page. The booking app (white background) is separate — install it from the public page.",
      install: "Install",
      dismiss: "Not now",
    },
  },
  fr: {
    ...
    installGestaoApp: {
      ...
      description: "Ajoutez l'app de gestion à l'écran d'accueil (icône fond noir).",
      iosHint: "Dans Safari, sur cette page /gestao : touchez Partager, puis « Sur l'écran d'accueil ».",
      androidHint: "Dans Chrome : 1) supprimez l'ancienne icône de gestion 2) ouvrez ce lien dans Chrome 3) touchez ⋮ 4) « Installer l'application » ou « Ajouter à l'écran d'accueil ».",
      manualHint: "Dans le menu du navigateur (⋮ ou Partager), sur cette page /gestao, choisissez « Installer l'application » ou « Sur l'écran d'accueil ».",
      standaloneHint: "Vous êtes dans une ancienne app. Fermez-la complètement, ouvrez ce lien dans Chrome, puis réinstallez (⋮ → Installer l'application).",
      separateNote: "Il faut le faire depuis la page de gestion. L'app de réservation (fond blanc) est séparée — installez-la depuis la page publique.",
      install: "Installer",
      dismiss: "Pas maintenant",
    },
  },
  es: {
    ...
    installGestaoApp: {
      ...
      description: "Añade la app de gestión a la pantalla de inicio (icono con fondo negro).",
      iosHint: "En Safari, en esta página /gestao: toca Compartir y luego «Añadir a pantalla de inicio».",
      androidHint: "En Chrome: 1) borra el icono antiguo de gestión 2) abre este enlace en Chrome 3) toca ⋮ 4) «Instalar aplicación» o «Añadir a pantalla de inicio».",
      manualHint: "En el menú del navegador (⋮ o Compartir), en esta página /gestao, elige «Instalar app» o «Añadir a pantalla de inicio».",
      standaloneHint: "Estás dentro de una app antigua. Ciérrala por completo, abre este enlace en Chrome e instala de nuevo (⋮ → Instalar aplicación).",
      separateNote: "Tiene que ser desde esta página de gestión. La app de reservas (fondo blanco) es otra — se instala desde la página pública.",
      install: "Instalar",
      dismiss: "Ahora no",
    },
  },
